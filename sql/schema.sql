...
domain varchar(100),
business varchar(10000),
vehicle varchar(10000),
vehicle_plate varchar(100),
proceedings varchar(60000),
...
id_server integer PRIMARY KEY AUTO_INCREMENT,
address varchar(100),
...
describe_service varchar(10000),
...
id_other integer PRIMARY KEY AUTO_INCREMENT,
other_information varchar(100000),
